...
This is the seed file for the schedule **collection** in `lib/schedules.js`: on the
...
`lib/schedules.js`, all persisted to localStorage. The edited schedule's name is
